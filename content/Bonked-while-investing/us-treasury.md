...
| **구분**        | **정식 명칭 발음**                                             | **국내 언론·시장 통칭**                              | **영미권 시장 구어·약어**                                                |
| ------------- | -------------------------------------------------------- | -------------------------------------------- | --------------------------------------------------------------- |
| **T-Bill**    | **티빌**<br><br>  <br>  <br><br>(Treasury Bills: 트레저리 빌즈)  | **미국 단기국채**, **단기물 국채**, **미 재무부 단기채**       | **T-Bills** (티빌즈), **Bills** (빌즈)                               |
| **T-Bond**    | **티본드**<br><br>  <br>  <br><br>(Treasury Bonds: 트레저리 본즈) | **미국 장기국채**, **초장기물 국채**, **미 국채 20년물/30년물** | **T-Bonds** (티본즈), **Bonds** (본즈), **Long Bond** (롱본드, 30년물 지칭) |
| _(참고) T-Note_ | **티노트**<br><br>  <br>  <br><br>(Treasury Notes: 트레저리 노츠) | **미국 중기국채**, **미 국채 10년물/2년물**               | **T-Notes** (티노츠), **Notes** (노츠), **Benchmark 10Y**            |
